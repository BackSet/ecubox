...
export const ECUBOX_PDF_COLORS = {
  background: [242, 243, 245] as PdfRgb,
  card: [255, 255, 255] as PdfRgb,
  cardSoft: [248, 248, 251] as PdfRgb,
  cardHeader: [237, 233, 254] as PdfRgb,
  text: [13, 13, 15] as PdfRgb,
  textStrong: [13, 13, 15] as PdfRgb,
  muted: [92, 92, 102] as PdfRgb,
  border: [222, 223, 229] as PdfRgb,
  borderSoft: [231, 232, 236] as PdfRgb,
  primary: [108, 92, 231] as PdfRgb,
  primaryDark: [75, 63, 176] as PdfRgb,
  primarySoftFill: [237, 233, 254] as PdfRgb,
  primarySoftStroke: [148, 134, 244] as PdfRgb,
  success: [21, 128, 61] as PdfRgb,
...
export const ECUBOX_HEX_COLORS = {
  ...
  primary: '6C5CE7',
  primaryDark: '4B3FB0',
  primarySoftFill: 'EDE9FE',
  primarySoftStroke: '9486F4',
  success: '15803D',
  successFill: 'E4F7E9',
