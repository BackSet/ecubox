...
export function PesajePage() {
  ...
  const [consignatarioFiltro, setConsignatarioFiltroRaw] = useState<
    string | undefined
  >(undefined);
  ...
  const setConsignatarioFiltro = (v: string | undefined) => { setConsignatarioFiltroRaw(v); setPage(0); };
  ...
  // Consignatarios distintos presentes en los paquetes.
   ...
   * filtros activos (envio, guia master, consignatario, busqueda) y el operario
  ...
  }, [paquetes, search, envioFiltro, guiaMasterFiltro, consignatarioFiltro]);
  ...
  const limpiarFiltros = useCallback(() => {
    ...
    setConsignatarioFiltroRaw(undefined);
  ...
  return (
    <div className="page-stack">
      ...
      <ListToolbar
        title="Pesaje"
        searchPlaceholder="Buscar por ref, guía/master, consignatario, contenido o envío..."
