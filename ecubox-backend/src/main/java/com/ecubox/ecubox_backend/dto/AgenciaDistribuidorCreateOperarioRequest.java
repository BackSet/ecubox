...
/** Body para crear una agencia de distribuidor desde el flujo de despacho (operario). Sin nombre ni código. */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AgenciaDistribuidorCreateOperarioRequest {
