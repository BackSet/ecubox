...
/**
 * Snapshot inmutable de un {@link DestinatarioFinal} en un momento dado
 ...
 * datos del destino se "congelan" para garantizar que el envio se
 * imprima/despache con los datos historicos correctos.</p>
 */
@Entity
@Table(name = "destinatario_final_version")
@Getter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class DestinatarioFinalVersion {
