...
- **Navegación por audiencia (rótulos de grupos del sidebar)**: fuente única `dashboardNav.ts`. Cliente: grupos **Principal** y **Mis envíos** (Mi casillero · Destinatarios · Mis guías · Mis entregas). Operario: **Inicio y seguimiento**, **Gestión de clientes**, **Recepción y transporte**, **Entrega y cierre**, **Red de entrega**. Admin añade **Accesos y seguridad** y **Configuración**. Usuario mixto (operario+cliente, no admin) añade **Mi cuenta** (Mi casillero · Mis guías · Mis entregas). La audiencia se deriva de permisos, no del nombre del rol.
